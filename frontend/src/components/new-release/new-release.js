            ...
            <div id="carouselExampleIndicators" className="carousel slide" data-ride="carousel">
                ...
                <div className="carousel-inner" role="listbox">
                    <div className="carousel-item active">
                        <a target="_blank" href="https://en.wikipedia.org/wiki/2019_in_video_gaming">
                    ...
                    <div className="carousel-item">
                        <a target="_blank" href="https://en.wikipedia.org/wiki/Borderlands_3">
                    ...
                    <div className="carousel-item">
                        <a target="_blank" href="https://en.wikipedia.org/wiki/Mario_Kart">
                    ...
                    <div className="carousel-item">
                        <a target="_blank" href="https://en.wikipedia.org/wiki/Grid_2">
