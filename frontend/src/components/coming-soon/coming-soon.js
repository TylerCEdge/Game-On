...
<div className="coming-soon-row row">
    <div className="col-xs-2">
        ...
        <PopoverBody>Game Type: Action-Adventure. <br/> Developed By: Sumo Digital. <br/> Release Date: February 2019. <br/> <a className="moreInfo" target="_blank" href="https://en.wikipedia.org/wiki/Crackdown_3">More Info</a></PopoverBody>
      </UncontrolledPopover>
    </div>
    <div className="col-xs-2">
        ...
        <PopoverBody>Game Type: Fighting. <br/> Developed By: Team Ninja. <br/> Release Date: March 2019. <br/> <a className="moreInfo" target="_blank" href="https://en.wikipedia.org/wiki/Dead_or_Alive_6">More Info</a></PopoverBody>
      </UncontrolledPopover>
    </div>
    <div className="col-xs-2">
        ...
        <PopoverBody>Game Type: Action-Adventure. <br/> Developed By: Remedy Entertainment. <br/> Release Date: August 2019. <br/> <a className="moreInfo" target="_blank" href="https://en.wikipedia.org/wiki/Control_(video_game)">More Info</a></PopoverBody>
      </UncontrolledPopover>
    </div>
    <div className="col-xs-2">
        ...
        <PopoverBody>Game Type: Survival-Horror. <br/> Developed By: Capcom. <br/> Release Date: January 2019. <br/> <a className="moreInfo" target="_blank" href="https://en.wikipedia.org/wiki/Resident_Evil_2_(2019_video_game)">More Info</a></PopoverBody>
      </UncontrolledPopover>
    </div>
